...
public interface ConductorRepository extends JpaRepository<Conductor, Long> {
    ...
    List<ConductorDTO> findAllByNombre(String text);

    List<ConductorDTO> findAllByNombreStartingWith(String text);

    List<ConductorDTO> findAllByNombreStartingWithIgnoreCase(String text);
